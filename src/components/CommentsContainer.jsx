...
// comment is an array which is a collection of an objects
// In comments there could be n level nesting
// Every Comment have their replies and this replies have thier replies and many more...
const commentsData = [
  {
    name: "Sachin Ghutukade",
    text: "Lorem ipsum dolor sit anet",
    replies: [
      {
        name: "Sachin Ghutukade",
        text: "Lorem ipsum dolor sit anet",
